...
# ------------------ OCR Configuration ------------------
pytesseract.pytesseract.tesseract_cmd = r"C:\\Program Files\\Tesseract-OCR\\tesseract.exe" # Update this path if Tesseract is installed elsewhere (Installing link in requierments.txt)
